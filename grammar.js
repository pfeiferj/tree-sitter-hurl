module.exports = grammar({
  ...
  rules: {
    ...
    html_escape_filter: ($) => seq("htmlEscape"),
    html_unescape_filter: ($) => seq("htmlUnescape"),
    to_int_filter: ($) => seq("toInt"),
    days_after_now_filter: ($) => seq("daysAfterNow"),
    days_before_now_filter: ($) => seq("daysBeforeNow"),
    decode_filter: ($) => seq("decode"),
    format_filter: ($) => seq("format"),
