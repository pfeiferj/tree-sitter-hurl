...
(
  (section_type) @method
  (#match? @method "(QueryStringParams)|(FormParams)|(MultipartFormData)|(Cookies)|(Options)|(BasicAuth)|(Asserts)|Captures")
) @property

(
  (section_type) @method
  (#not-match? @method "(QueryStringParams)|(FormParams)|(MultipartFormData)|(Cookies)|(Options)|(BasicAuth)|(Asserts)|Captures")
) @error
;
;"[Captures]" @property
;"[Asserts]" @property
